...
<head>
    ...
    <title>Seklistapp - Admin Panel</title>
...
max-width: 100%;
            ...
            <a class="sidebar-brand d-flex align-items-center" href="dashboard.php">
                <div class="sidebar-brand-icon">
                    <i class=""></i>
                    <img src="../assets/images/seklistapp-logo2.png" style="margin-top:50px; margin-left:30px; height: 100px; width:130px;" alt="">
                </div>
                <!--div class="sidebar-brand-text mx-3">SEKLISTAPP</div-->
            </a><br><br>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="header-date pull-left" style="margin-top:25px; margin-right:680px;">
        <strong><?php echo date("F j, Y"), '&nbsp;|&nbsp;', date('l');?></strong>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="messagesDropdown" style="max-height:275px; overflow-x:hidden; overflow-y:auto;" style="background:#e74a3b;">
